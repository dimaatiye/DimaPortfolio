...
static const GLfloat vertices[] =
{
	...
	-1.00f,  0.00f,  1.00f,	// [3]	// ( 4)
	 ...
	 1.00f,  0.00f, 0.00f,	// [6]	// ( 6)
	-1.00f,  0.00f, 0.00f,	// [7]	// ( 7)

	// Back Face
	 1.00f, -1.00f, 0.00f,	// [5]	// ( 8)
	-1.00f, -1.00f, 0.00f, // [4]	// ( 9)
	-1.00f,  0.00f, 0.00f,	// [7]	// (10)
	 1.00f,  0.00f, 0.00f,	// [6]	// (11)

	// Bottom Face
	-1.00f, -1.00f, 0.00f, // [4]	// (12)
	 1.00f, -1.00f, 0.00f, // [5]	// (13)
	 1.00f, -1.00f,  1.00f, // [1]	// (14)
	-1.00f, -1.00f,  1.00f, // [0]	// (15)

	// Left Face
	-1.00f, -1.00f, 0.00f, // [4]	// (16)
	-1.00f, -1.00f,  1.00f, // [0]	// (17)
	-1.00f,  0.00f,  1.00f, // [3]	// (18)
	-1.00f,  0.00f, 0.00f, // [7]	// (19)

	// Right Face
	 1.00f, -1.00f,  1.00f, // [1]	// (20)
	 1.00f, -1.00f, 0.00f, // [5]	// (21)
	 1.00f,  0.00f, 0.00f, // [6]	// (22)
...
static const GLfloat npc_colours[] = {
